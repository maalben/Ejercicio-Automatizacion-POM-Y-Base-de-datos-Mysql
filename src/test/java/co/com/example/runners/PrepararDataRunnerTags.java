...
@CucumberOptions(
        features = "src/test/resources/features/preparardata.feature",
        glue = "co.com.example.definitions",
        snippets = SnippetType.UNDERSCORE
)

public class PrepararDataRunnerTags {
    @BeforeSuite
    public static void test() throws IOException, InvalidFormatException {
        DataToFeature.overrideFeatureFiles("./src/test/resources/features/preparardata.feature");
    }
}
